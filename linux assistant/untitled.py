...
try:
		import assistant_helpers, audio_helpers, device_helpers
                        						...
                        						if ismpvplaying():
                            							if 'set'.lower() in str(usrcmd).lower() or 'change'.lower() in str(usrcmd).lower():
                                								if 'hundred'.lower() in str(usrcmd).lower() or 'maximum' in str(usrcmd).lower():
                                    									settingvollevel=100
                                    									with open('/home/chirag/Desktop/snehil/.mediavolume.json', 'w') as vol:
                                								...
                                								if os.path.isfile("/home/chirag/Desktop/snehil/.mediavolume.json"):
                                    									with open('/home/chirag/Desktop/snehil/.mediavolume.json', 'r') as vol:
                                								...
                                								if 'increase'.lower() in str(usrcmd).lower():
                                    									...
                                    									with open('/home/chirag/Desktop/snehil/.media', 'w') as vol:
                                        										json.dump(settingvollevel, vol)
                                    									mpvsetvol=os.system("echo '"+json.dumps({ "command": ["set_property", "volume",str(settingvollevel)]})+"' | socat - /tmp/mpvsocket")
...
def main(api_endpoint, credentials, project_id,
		...
		with SampleAssistant(lang, device_model_id, device_id,
				...
				model = "/home/chirag/Downloads/hay you.pmdl"
				...
				detector.start(detected_callback=assistant.assist,
